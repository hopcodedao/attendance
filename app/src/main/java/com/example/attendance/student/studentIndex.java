...
import com.example.attendance.fragment.attendance;
...
import com.example.attendance.qrstudent;
...
public class studentIndex extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Common.currentEmployee = profiledatabase;
                SharedPreferences preferences = getSharedPreferences("SharedPreferencesName", Context.MODE_PRIVATE);
                SharedPreferences.Editor editor = preferences.edit();
                editor.putString("face", (profiledatabase.getFacedata().equals("null") ? "{}" : profiledatabase.getFacedata()));
                ...
                String address=profiledatabase.getAddress();
                String birthofdate=profiledatabase.getBrithofDate();
                String number=profiledatabase.getNumber();

                String course=profiledatabase.getFaculty();
                String rollnumber=profiledatabase.getMSSV();
                String year=profiledatabase.getYear();
                String division=profiledatabase.getClazz();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_Studentnoti) {
            ...
            getSupportFragmentManager().beginTransaction().replace(R.id.scm, new attendance()).commit();
        }else if (id == R.id.nav_Qrcode) {
                getSupportFragmentManager().beginTransaction().replace(R.id.scm , new qrstudent()).commit();
